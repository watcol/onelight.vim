...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  " Treesitter Support ------------------------------------------------------{{{
  call s:h('TSAnnotation',         s:purple,      '',     '')
  call s:h('TSAttribute',          s:yellow,      '',     '')
  call s:h('TSBoolean',            s:dark_yellow, '',     '')
  call s:h('TSCharacter',          s:green,       '',     '')
  call s:h('TSComment',            s:dark_grey,   '',     s:italic)
  call s:h('TSConditional',        s:purple,      '',     '')
  call s:h('TSConstBuiltin',       s:yellow,      '',     '')
  call s:h('TSConstMacro',         s:cyan,        '',     '')
  call s:h('TSConstant',           s:yellow,      '',     '')
  call s:h('TSConstructor',        s:dark_black,  '',     '')
  call s:h('TSEmphasis',           s:none,        s:none, 'bold')
  call s:h('TSError',              s:dark_red,    '',     '')
  call s:h('TSException',          s:purple,      '',     '')
  call s:h('TSField',              s:dark_red,    '',     '')
  call s:h('TSFloat',              s:dark_yellow, '',     '')
  call s:h('TSFuncBuiltin',        s:cyan,        '',     '')
  call s:h('TSFuncMacro',          s:purple,      '',     '')
  call s:h('TSFunction',           s:blue,        '',     '')
  call s:h('TSInclude',            s:dark_red,    '',     '')
  call s:h('TSKeyword',            s:purple,      '',     '')
  call s:h('TSKeywordFunction',    s:purple,      '',     '')
  call s:h('TSLabel',              s:purple,      '',     '')
  call s:h('TSMethod',             s:blue,        '',     '')
  call s:h('TSNamespace',          s:dark_black,  '',     '')
  call s:h('TSNumber',             s:dark_yellow, '',     '')
  call s:h('TSOperator',           s:purple,      '',     '')
  call s:h('TSParameter',          s:dark_black,  '',     '')
  call s:h('TSParameterReference', s:dark_black,  '',     '')
  call s:h('TSProperty',           s:dark_red,    '',     '')
  call s:h('TSPunctBracket',       s:dark_black,  '',     '')
  call s:h('TSPunctDelimiter',     s:dark_black,  '',     '')
  call s:h('TSPunctSpecial',       s:yellow,      '',     '')
  call s:h('TSRepeat',             s:purple,      '',     '')
  call s:h('TSString',             s:green,       '',     '')
  call s:h('TSStringEscape',       s:blue,        '',     '')
  call s:h('TSStringRegex',        s:blue,        '',     '')
  call s:h('TSStructure',          s:dark_red,    '',     '')
  call s:h('TSTag',                s:dark_red,    '',     '')
  call s:h('TSTagDelimiter',       s:purple,      '',     '')
  call s:h('TSText',               s:green,       '',     '')
  call s:h('TSType',               s:yellow,      '',     '')
  call s:h('TSTypeBuiltin',        s:yellow,      '',     '')
  call s:h('TSUnderline',          s:none,        s:none, 'underline')
  call s:h('TSURI',                s:dark_grey,   '',     '')
  call s:h('TSVariable',           s:dark_black,  '',     '')
  call s:h('TSVariableBuiltin',    s:dark_red,    '',     '')
  "  }}}
