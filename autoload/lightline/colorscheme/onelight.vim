...
let s:p.replace.right   = [ [ s:bg, s:dark_red, 'bold' ], [ s:fg, s:dark_grey ] ]
let s:p.replace.left    = [ [ s:bg, s:dark_red, 'bold' ], [ s:fg, s:dark_grey ] ]
...
let s:p.tabline.right   = [ [ s:fg, s:dark_grey ] ]
