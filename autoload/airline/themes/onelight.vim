...
function! airline#themes#onelight#refresh()
  ...
  let g:airline#themes#onelight#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
  ...
  let s:I3 = s:N3
  let g:airline#themes#onelight#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
  ...
  let s:R2 = s:N2
  let s:R3 = s:N3
  let g:airline#themes#onelight#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
  ...
  let s:V3 = s:N3
  let g:airline#themes#onelight#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
  ...
  let g:airline#themes#onelight#palette.inactive_modified = {
        \ 'airline_c': [ group[0], '', group[2], '', '' ]
        \ }
endfunction
